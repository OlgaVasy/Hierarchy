...
public class MegaCorp implements Hierarchy<Capitalist, FatCat> {	
   ...
   @Override
    ...
    public List<FatCat> getParentChain(Capitalist capitalist) {
    	...
    	if(capitalist==null)
    		return list;
    	while(capitalist.hasParent()&&set.contains(capitalist.getParent())){
